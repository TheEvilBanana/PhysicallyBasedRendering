...
public:
	...
	void PBRRenderProcess(GameEntity* &gameEntity, ID3D11Buffer* &vertexBuffer, ID3D11Buffer* &indexBuffer, SimpleVertexShader* &vertexShader, SimplePixelShader* &pixelShader, Camera* &camera, ID3D11DeviceContext* &context, float m, float r, ID3D11ShaderResourceView* &skyIR, ID3D11ShaderResourceView* &skyPrefilter, ID3D11ShaderResourceView* &brdfLUT, ID3D11SamplerState* &sampler);
	void PBRMatRenderProcess(GameEntity* &gameEntity, ID3D11Buffer* &vertexBuffer, ID3D11Buffer* &indexBuffer, SimpleVertexShader* &vertexShader, SimplePixelShader* &pixelShader, Camera* &camera, ID3D11DeviceContext* &context, ID3D11ShaderResourceView* &skyIR, ID3D11ShaderResourceView* &skyPrefilter, ID3D11ShaderResourceView* &brdfLUT, ID3D11SamplerState* &sampler);
